...
| A search about here is held to the saved place, every round | Deployed 2026-09-03 (e4f68ba8) | `conversation_service._hold_to_place`, `test_search_keeps_the_place.py` |
