...
| Chat orchestration | What happens from message submission through memory retrieval, Gemma streaming, persistence, and SSE completion? | [chat-orchestration.mmd](chat-orchestration.mmd) | [chat-orchestration.svg](chat-orchestration.svg) |
...
| Tool memory | What safe MCP-related metadata is stored, embedded, retrieved, and explicitly not executable? | [tool-memory-subsystem.mmd](tool-memory-subsystem.mmd) | [tool-memory-subsystem.svg](tool-memory-subsystem.svg) |
