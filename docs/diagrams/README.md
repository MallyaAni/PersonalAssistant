...
| Trading desk | Adopted scheduled allocation and FOMC paper execution, dated quote eligibility, manual personal positions, and separate immutable forward-research evaluation. | [source](agent-trading-desk.mmd) | [view](agent-trading-desk.svg) |
