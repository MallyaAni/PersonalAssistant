...
| Tasks and skills | How does "remind me every weekday at 7" become a saved task, how does "morning brief" reach a taught skill by meaning, and how does a due task become a turn delivered back to the person? | [scheduled-tasks-subsystem.mmd](scheduled-tasks-subsystem.mmd) | [scheduled-tasks-subsystem.svg](scheduled-tasks-subsystem.svg) |
