...
| Runtime and deployment | Which processes run where, on which ports, and through which protocols, including the local visual FastMCP sidecar? | [runtime-deployment.mmd](runtime-deployment.mmd) | [runtime-deployment.svg](runtime-deployment.svg) |
