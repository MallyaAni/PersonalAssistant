...
What breaks when this is wrong:
  ...
  - 2026-08-26, over iMessage: in a conversation about Netflix's "Surviving
    ...
    season" as "Love Island USA seasons" - the router substituted shows of
    its own for the one the conversation named, and the reply answered
    about them. The subject of a follow-up is copied, never replaced.
