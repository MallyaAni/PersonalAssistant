...
export interface DeskPayload {
  ...
  event_status?: { as_of?: string; status?: string; stale: boolean; active: boolean; planning_paused: boolean; pending_orders: number; policy?: DeskRecord['event_risk']; sold?: Record<string, number> };
