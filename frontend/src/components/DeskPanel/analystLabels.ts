...
export const EVENING_VOTE_CONTEXT = 'Evening votes use a three-session confirmation rule; the latest readings may differ from those that established a vote. Computed intraday votes apply the same confirmation rule, using the live bar as today’s session.'
