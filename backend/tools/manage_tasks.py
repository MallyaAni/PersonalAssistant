...
TOOL = BuiltinTool(
    ...
    description=(
        ...
        "assistant made - a reminder, Scout's schedule, a fact it just "
        "saved to memory, or a document it was given - 'undo that', 'forget "
        "that', 'forget that document', 'put it back', 'never mind, restore "
        "the stretch reminder' - the application knows which change was last. "
