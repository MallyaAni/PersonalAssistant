...
Both facts the provider needs - what to draw, and whether it shows a person -
now come from the model that wrote the prompt, which is the only thing here
that understands the request. They used to be recovered afterwards by matching
its wording: a preamble stripper that had to anticipate every way somebody
might ask, and a word list that read "draw me a picture of my car" as a person
